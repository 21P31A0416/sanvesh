  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        "/JapanLanguages":(context)=>JapanLanguages(),
        "/JapanExams":(context)=>JapanExam(),
        "/JapanSafty":(context)=>JapanSafty(),
        ...
        "/AustraliaLanguages":(context)=>AustraliaLanguages(),
        "/AustraliaExam":(context)=>AustraliaExam(),
        "/AustraliaSafty":(context)=>AustraliaSafty(),
        "/CanadaColleges":(context)=>CanadaColleges(),
        "/CanadaDocuments":(context)=>CanadaDocuments(),
        "/CanadaExams":(context)=>CanadaExams(),
        "/CanadaLanguages":(context)=>CanadaLanguages(),
        "/CanadaSafty":(context)=>CanadaSafty(),
        ...
        "/DenmarkLanguages":(context)=>DenmarkLanguages(),
        "/DenmarkExams":(context)=>DenmarkExams(),
        "/DenmarkSafty":(context)=>DenmarkSafty(),
        ...
        "/NetherlandsLanguages":(context)=>NetherlandsLanguages(),
        "/NetherlandsExams":(context)=>NetherlandsExams(),
        "/NetherlandsSafty":(context)=>NetherlandsSafty(),
        ...
        "/SingaporeLanguages":(context)=>SingaporeLanguages(),
        "/SIngaporeExams":(context)=>SingaporeExams(),
        "/SIngaporeSafty":(context)=>SingaporeSafty(),
        ...
        "/NewzealandLanguages":(context)=>NewzealandLanguages(),
        "/NewzealandExams":(context)=>NewzealandExams(),
        "/NewzealandSafty":(context)=>NewzealandSafty(),
        ...
        "/FranceLanguages":(context)=>FranceLanguages(),
        "/FranceExams":(context)=>FranceExams(),
        "/FranceSafty":(context)=>FranceSafty(),
        ...
        "/GermanyLanguages":(context)=>GermanyLanguages(),
        "/GermanyExams":(context)=>GermanyExams(),
        "/GermanySafty":(context)=>GermanySafty(),
