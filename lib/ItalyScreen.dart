...
class _ItalyScreenState extends State<ItalyScreen> {
  ...
  var l = [
    ...
    FF(image: "https://media.istockphoto.com/id/675281706/photo/speaking-on-different-lenguages.webp?b=1&s=612x612&w=0&k=20&c=hzGrK9n_ac7b4gFV19iTGpTKoqkoREryGgBLDn5al6M=", Text: "Languages to be Known", text: "/ItalyLanguages"),
    FF(image: "https://cdn.pixabay.com/photo/2018/09/04/10/06/man-3653346_640.jpg", Text: "Entrance Exams", text: "/ItalyExams"),
    FF(image: "https://cdn.pixabay.com/photo/2014/02/13/07/28/security-265130_640.jpg", Text: "How safe is the country for the students ?", text: "/ItalySafty"),];
  @override
...
class ItalyLanguages extends StatefulWidget {
  const ItalyLanguages({super.key});

  @override
  State<ItalyLanguages> createState() => _ItalyLanguagesState();
}

class _ItalyLanguagesState extends State<ItalyLanguages> {
  @override
  Widget build(BuildContext context) {
    double hi = MediaQuery.of(context).size.height;
    double wi = MediaQuery.of(context).size.width;
...
class ItalySafty extends StatefulWidget {
  const ItalySafty({super.key});

  @override
  State<ItalySafty> createState() => _ItalySaftyState();
}

class _ItalySaftyState extends State<ItalySafty> {
  @override
  Widget build(BuildContext context) {
    double hi = MediaQuery.of(context).size.height;
    double wi = MediaQuery.of(context).size.width;
